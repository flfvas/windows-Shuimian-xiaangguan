...
Plugins_Gui:
    ...
    Gui,PluginsManage:Show, , hzn_全局按键管理器
    Critical,Off
return
LVMenu(addMenu){
...
return
; LVPluginsSwap:
;     IniWrite,% !PluginsListViewSwap,%Hznconfig%,Config,PluginsListViewSwap
;     Gosub,Plugins_Gui
; return
LVApply:
    Gui,PluginsManage:Default
...
LVPluginsCreate:
    ...
    loop
    {
        InputBox, newObjRegInput, 新建快捷键规则文件,注意不要带空格,,,,,,,,.ahk
        if !ErrorLevel
        {
...
#IfWinActive 
            ...
            IniWrite,1,%Hznconfig%,Plugins,%newObjRegInput%
            Gosub,Plugins_Gui
